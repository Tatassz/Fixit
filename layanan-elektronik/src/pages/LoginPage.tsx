  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        // After authService.setToken(token)
        console.log(
          "🔑 After setToken - authService has token?",
      ...
      // ✅ Use AuthContext login - this handles everything properly
      toast.success(isAdmin ? "Login admin berhasil!" : "Login berhasil!", {
        description: `Selamat datang, ${response.user.name}!`,
      });

      // Small delay for toast to show, then login (which navigates)
      setTimeout(() => {
